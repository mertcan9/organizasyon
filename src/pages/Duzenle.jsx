...
const Duzenle = () => {
  ...
  const fetchData = async () => {
    try {
      ...
      let complexData = {};
      try {
        if (data.ek_notlar && data.ek_notlar.startsWith('{')) {
          complexData = JSON.parse(data.ek_notlar);
        }
      } catch (e) {
        console.log("Notlar JSON değil, düz metin.");
      }
      ...
      setFormData({
        ...
        ek_istekler: complexData.ek_istekler || (complexData._is_complex ? '' : data.ek_notlar),
